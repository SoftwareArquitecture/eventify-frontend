...
const routes = [
    ...
    { path: '/events/create', name: 'event-create', component: () => import('../event-management/components/event-create-and-edit-dialog.component.vue') },
    { path: '/events/:id/edit', name: 'event-edit', component: () => import('../event-management/components/event-create-and-edit-dialog.component.vue'), props: route => ({ id: route.params.id }) },
